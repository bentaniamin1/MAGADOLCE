...
request.onload = function() {
    if(this.status >= 200 && this.status < 400) {
        ...
        let gt_et = document.getElementById("g_et").addEventListener("click",()=>{
            ...
            console.log(contenu1.gateaux_etrangers.length);
                let html1 = `
                <section>
                <div>
                <img id ="imge"src="${contenu1.gateaux_etrangers[0].image} " alt="">
                <h1>${contenu1.gateaux_etrangers[0].nom}</h1>
                <h2>${contenu1.gateaux_etrangers[0].prix} $</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente corrupti molestiae voluptates quis, eum ratione reprehenderit atque vel. Ad, necessitatibus. Eveniet architecto quidem delectus nulla, totam iste sed veritatis eius.</p>
                <button id ="ajouter${contenu1.gateaux_etrangers[0].id}">Ajouter au panier</button>
                </div>
                </section>
                <section>
                <div>
                <img id ="imge"src="${contenu1.gateaux_etrangers[1].image}" alt="">
                <h1>${contenu1.gateaux_etrangers[1].nom}</h1>
                <h2>${contenu1.gateaux_etrangers[1].prix} $</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente corrupti molestiae voluptates quis, eum ratione reprehenderit atque vel. Ad, necessitatibus. Eveniet architecto quidem delectus nulla, totam iste sed veritatis eius.</p>
                <button id = "ajouter${contenu1.gateaux_etrangers[1].id}">Ajouter au panier</button>
                </div>
                </section>
                <section>
                <div>
                <img id ="imge"src="${contenu1.gateaux_etrangers[2].image}" alt="">
                <h1>${contenu1.gateaux_etrangers[2].nom}</h1>
                <h2>${contenu1.gateaux_etrangers[2].prix} $</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente corrupti molestiae voluptates quis, eum ratione reprehenderit atque vel. Ad, necessitatibus. Eveniet architecto quidem delectus nulla, totam iste sed veritatis eius.</p>
                <button id ="ajouter${contenu1.gateaux_etrangers[2].id}">Ajouter au panier</button>
                </div>
                </section>
                <section>
                <div>
                <img id ="imge"src="${contenu1.gateaux_etrangers[3].image} " alt="">
                <h1>${contenu1.gateaux_etrangers[3].nom}</h1>
                <h2>${contenu1.gateaux_etrangers[3].prix} $</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente corrupti molestiae voluptates quis, eum ratione reprehenderit atque vel. Ad, necessitatibus. Eveniet architecto quidem delectus nulla, totam iste sed veritatis eius.</p>
                <button id ="ajouter${contenu1.gateaux_etrangers[3].id}">Ajouter au panier</button>
                </div>
                </section>
                <section>
                <div>
                <img id ="imge"src="${contenu1.gateaux_etrangers[4].image} " alt="">
                <h1>${contenu1.gateaux_etrangers[4].nom}</h1>
                <h2>${contenu1.gateaux_etrangers[4].prix} $</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente corrupti molestiae voluptates quis, eum ratione reprehenderit atque vel. Ad, necessitatibus. Eveniet architecto quidem delectus nulla, totam iste sed veritatis eius.</p>
                <button id ="ajouter${contenu1.gateaux_etrangers[4].id}">Ajouter au panier</button>
                </div>
                </section>
                <section>
                <div>
                <img id ="imge"src="${contenu1.gateaux_etrangers[5].image} " alt="">
                <h1>${contenu1.gateaux_etrangers[5].nom}</h1>
                <h2>${contenu1.gateaux_etrangers[5].prix} $</h2>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente corrupti molestiae voluptates quis, eum ratione reprehenderit atque vel. Ad, necessitatibus. Eveniet architecto quidem delectus nulla, totam iste sed veritatis eius.</p>
                <button id ="ajouter${contenu1.gateaux_etrangers[5].id}">Ajouter au panier</button>
                </div>
                </section>
            ...
            btngateaux_etrangers.addEventListener("click",()=>{
                console.log(contenu1.gateaux_etrangers[0]);
                //let ob0 = contenu1.gateaux_etrangers[1];
                //localStorage.setItem("listePanier", JSON.stringify(ob0));
                let pr = JSON.parse(localStorage.getItem('listePanier'));
                pr.push(contenu1.gateaux_etrangers[0]);
                localStorage.setItem('listePanier', JSON.stringify(pr));
                //on rècupere le nombre length dans la liste objt du local storage
                let listePanierligne1 = localStorage.getItem("listePanier");
                let listePanier1 = JSON.parse(listePanierligne1);
                //faire avec iltrer
                console.log(listePanier1);
                console.log(contenu1.gateaux_etrangers[0].nom);
    
                if(listePanier1.nom != contenu1.gateaux_etrangers[0].nom ){
                    let ajour = nmbrPanier.innerHTML = nmbrPanierValue + listePanier1.length;
                }else{
                    nmbrPanier.innerHTML = listePanier1.length - 10 ;
                }
            ...
            btngateaux_etrangers1.addEventListener("click",()=>{
                console.log(contenu1.gateaux_etrangers[1]);
                //let ob0 = contenu1.gateaux_etrangers[1];
                //localStorage.setItem("listePanier", JSON.stringify(ob0));
                let pr = JSON.parse(localStorage.getItem('listePanier'));
                pr.push(contenu1.gateaux_etrangers[1]);
                localStorage.setItem('listePanier', JSON.stringify(pr));
                //on rècupere le nombre length dans la liste objt du local storage
                let listePanierligne1 = localStorage.getItem("listePanier");
                let listePanier1 = JSON.parse(listePanierligne1);
                //faire avec iltrer
                console.log(listePanier1);
                console.log(contenu1.gateaux_etrangers[1].nom);
    
                if(listePanier1.nom != contenu1.gateaux_etrangers[1].nom ){
                    let ajour = nmbrPanier.innerHTML = nmbrPanierValue + listePanier1.length;
                }else{
                    nmbrPanier.innerHTML = listePanier1.length - 10 ;
                }
            ...
            btngateaux_etrangers2.addEventListener("click",()=>{
                console.log(contenu1.gateaux_etrangers[2]);
                //let ob0 = contenu1.gateaux_etrangers[1];
                //localStorage.setItem("listePanier", JSON.stringify(ob0));
                let pr = JSON.parse(localStorage.getItem('listePanier'));
                pr.push(contenu1.gateaux_etrangers[2]);
                localStorage.setItem('listePanier', JSON.stringify(pr));
                //on rècupere le nombre length dans la liste objt du local storage
                let listePanierligne1 = localStorage.getItem("listePanier");
                let listePanier1 = JSON.parse(listePanierligne1);
                //faire avec iltrer
                console.log(listePanier1);
                console.log(contenu1.gateaux_etrangers[2].nom);
    
                if(listePanier1.nom != contenu1.gateaux_etrangers[2].nom ){
                    let ajour = nmbrPanier.innerHTML = nmbrPanierValue + listePanier1.length;
                }else{
                    nmbrPanier.innerHTML = listePanier1.length - 10 ;
                }
            ...
            btngateaux_etrangers3.addEventListener("click",()=>{
                console.log(contenu1.gateaux_etrangers[3]);
                //let ob0 = contenu1.gateaux_etrangers[1];
                //localStorage.setItem("listePanier", JSON.stringify(ob0));
                let pr = JSON.parse(localStorage.getItem('listePanier'));
                pr.push(contenu1.gateaux_etrangers[3]);
                localStorage.setItem('listePanier', JSON.stringify(pr));
                //on rècupere le nombre length dans la liste objt du local storage
                let listePanierligne1 = localStorage.getItem("listePanier");
                let listePanier1 = JSON.parse(listePanierligne1);
                //faire avec iltrer
                console.log(listePanier1);
                console.log(contenu1.gateaux_etrangers[3].nom);
    
                if(listePanier1.nom != contenu1.gateaux_etrangers[3].nom ){
                    let ajour = nmbrPanier.innerHTML = nmbrPanierValue + listePanier1.length;
                }else{
                    nmbrPanier.innerHTML = listePanier1.length - 10 ;
                }
            ...
            btngateaux_etrangers4.addEventListener("click",()=>{
                console.log(contenu1.gateaux_etrangers[4]);
                //let ob0 = contenu1.gateaux_etrangers[1];
                //localStorage.setItem("listePanier", JSON.stringify(ob0));
                let pr = JSON.parse(localStorage.getItem('listePanier'));
                pr.push(contenu1.gateaux_etrangers[4]);
                localStorage.setItem('listePanier', JSON.stringify(pr));
                //on rècupere le nombre length dans la liste objt du local storage
                let listePanierligne1 = localStorage.getItem("listePanier");
                let listePanier1 = JSON.parse(listePanierligne1);
                //faire avec iltrer
                console.log(listePanier1);
                console.log(contenu1.gateaux_etrangers[4].nom);
    
                if(listePanier1.nom != contenu1.gateaux_etrangers[4].nom ){
                    let ajour = nmbrPanier.innerHTML = nmbrPanierValue + listePanier1.length;
                }else{
                    nmbrPanier.innerHTML = listePanier1.length - 10 ;
                }
            ...
            btngateaux_etrangers5.addEventListener("click",()=>{
                ...
                //localStorage.setItem("listePanier", JSON.stringify(ob0));
                let pr = JSON.parse(localStorage.getItem('listePanier'));
                pr.push(contenu1.gateaux_etrangers[5]);
                localStorage.setItem('listePanier', JSON.stringify(pr));
                //on rècupere le nombre length dans la liste objt du local storage
                let listePanierligne1 = localStorage.getItem("listePanier");
                let listePanier1 = JSON.parse(listePanierligne1);
                //faire avec iltrer
                console.log(listePanier1);
                console.log(contenu1.gateaux_etrangers[5].nom);
    
                if(listePanier1.nom != contenu1.gateaux_etrangers[5].nom ){
                    let ajour = nmbrPanier.innerHTML = nmbrPanierValue + listePanier1.length;
                }else{
                    nmbrPanier.innerHTML = listePanier1.length - 10 ;
                }
